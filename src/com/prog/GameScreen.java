...
public class GameScreen extends JFrame implements ActionListener
{
    ...
    public GameScreen(String name)
    {
        ...
        setResizable(false);
        backgroundImage  = new ImageIcon("D:\\КПП\\sprites\\day2-bgr.jpg").getImage();
        ground = new ImageIcon("D:\\КПП\\sprites\\base.png").getImage();
        flappybird = new ImageIcon("D:\\КПП\\sprites\\blue_1.png").getImage();
        Constants.Init();
